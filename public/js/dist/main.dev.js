...
var configs = function () {
  ...
  var Singleton = function Singleton(options) {
...
var files = function () {
  ...
  Singleton.defaultOptions = {
    "mission_rules.txt": "If you forget your target, you can reveal it at any time by typing the reveal command in the database. To kill an agent, you must prompt them into saying their trigger word. Once you've slayed your target, scan the qr code on the back of their ID card and upload a selfie to our database for proof.",
    "contact.txt": "If you're looking for more information contact your mission director at 469-684-9560"
  };
  return {
    getInstance: function getInstance(options) {
      instance === void 0 && (instance = new Singleton(options));
...
var main = function () {
  ...
  var cmds = {
    LS: {
      value: "ls",
      help: configs.getInstance().ls_help
    },
    CAT: {
      value: "cat",
      help: configs.getInstance().cat_help
    },
    WHOAMI: {
      value: "whoami",
      help: configs.getInstance().whoami_help
    },
    DATE: {
      value: "date",
      help: configs.getInstance().date_help
    },
    HELP: {
      value: "help",
      help: configs.getInstance().help_help
    },
    CLEAR: {
      value: "clear",
      help: configs.getInstance().clear_help
    },
    REBOOT: {
      value: "reboot",
      help: configs.getInstance().reboot_help
    },
    CD: {
      value: "cd",
      help: configs.getInstance().cd_help
    },
    MV: {
      value: "mv",
      help: configs.getInstance().mv_help
    },
    RM: {
      value: "rm",
      help: configs.getInstance().rm_help
    },
    RMDIR: {
      value: "rmdir",
      help: configs.getInstance().rmdir_help
    },
    TOUCH: {
      value: "touch",
      help: configs.getInstance().touch_help
    },
    SUDO: {
      value: "sudo",
      help: configs.getInstance().sudo_help
    },
    REVEAL: {
      value: "reveal",
      help: configs.getInstance().reveal_help
    }
  };
  ...
  var TypeSimulator = function TypeSimulator(timer, output) {
  ...
  TypeSimulator.prototype.type = function (text, callback) {
    ...
    (function typer() {
      if (i < text.length) {
        ...
        var isNewLine = _char === "\n";
        output.innerHTML += isNewLine ? "<br/>" : _char;
        i++;
